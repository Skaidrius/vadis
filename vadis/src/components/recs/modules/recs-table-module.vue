     ...
     <div class='panel panel-default'>
      ...
      <div v-if='recommendations' >
        ...
        <table class='table table-hover table-bordered text-center'>
          ...
          <tbody v-for='( data, index ) in recommendations'>
            <tr>
              <td>{{ index+1 }}.</td>
              ...
              <td>
                <input type='checkbox' v-model='recommendations[ index ].marked' v-on:change='getMarked'/>
              </td>
            </tr>
        ...
        <div class="panel-footer">
          ...
          <div class='form-inline text-right' > 
            <button class='form-control' v-on:click='changeImplemented' v-show='marked > 0'>{{ functions.selectDone[ i18n ] }}</button>
          </div>
...
import ExpandRecsModule from './expand-recs-module.vue';

    import Vue from 'vue';
    
        // register modal component
    Vue.component('RecsTableModule', {
      template: '#recs-table'
    });
    ...
    module.exports = {
      ...
      props: [ 'i18n', 'editMode', 'sortByDate', 'sortByRate', 'sortByStatus', 'functions', 'tables', 'title', 'recommendationsArray', 'tableElements', 'recommendations', 'changeImplemented'],
      methods: {
