  ...
  <div>
    ...
    <nav>
      <ul class="my-tabs nav nav-pills">
        <li class='col-xs-2 active' data-toggle="tab"><router-link to="/demand/demand-table">{{ tableNav.table[i18n] }}</router-link></li>
        <li class='col-xs-2' data-toggle="tab"><router-link to="/demand/demand-table-selections">{{ tableNav.legend[i18n] }}</router-link></li>
      </ul>
    </nav>
